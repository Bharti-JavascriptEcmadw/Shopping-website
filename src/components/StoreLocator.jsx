...
const StoreLocator = () => {
  return (
    <div className="bg-[#fdfbf6] flex flex-col items-center mb-5">
      {/* Top Section */}
      <div className="w-full max-w-[1500px] flex flex-col lg:flex-row-reverse items-center lg:items-start justify-between mt-10 h-[80vh]">
        {/* Right Image */}
        <div className="w-full lg:w-1/2">
          <img
            src="/assets/img/23.jpg"
            alt="Top Banner"
            className="w-full h-[250px] sm:h-[300px] md:h-[400px] object-cover lg:max-w-[95%] lg:h-[400px]" // Responsive height for different screen sizes
          />
        </div>
        {/* Left Text Content */}
        <div className="w-full lg:w-1/2 p-6 lg:p-12 text-center lg:text-left">
          {/* <h1 className="text-xl font-semibold text-gray-800 mb-4">Store locator</h1> */}
