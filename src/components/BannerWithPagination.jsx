...
const BannerWithPagination = () => {
  ...
  return (
    <div className="relative flex flex-col items-center w-full h-screen bg-[#fdfbf6]">
      {/* Banner Content */}
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-[1500px] h-[60%] lg:h-[40%] bg-[#fdfbf6] xxs:flex-col items-center w-full  flex gap-5">
        {/* Right Content (Image) */}
